...
class A {
   ...
   * @param {object} options - An object where the properties are the properties of the javascript object/class your are testing and the value of each property is an array of possible values
   * @yields {object} an object where the value of each property is one of the possible values in the propertys array.
  ...
  *genCombos(options) {
   ...
   * @throws {Error} - Rejects and throws an error if timeout is reached and all tagNames have not been registered.
   */
...
document.addEventListener('DOMContentLoaded', () => {
  if (!customElements.get('a-testrunner')) {
